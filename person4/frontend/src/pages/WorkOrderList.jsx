                        ...
                        <div style={{ position: "relative" }}>
                            ...
                            {showInviteCode && (
                                ...
                                >
                                    ...
                                    >
                                        Share this code with your team members (Dispatchers &
                                        Technicians)
                                    </p>
                                    <div
                                        style={{
            ...
            <div style={{ padding: "32px", maxWidth: 1200, margin: "0 auto" }}>
                ...
                {loading ? (
                    ...
                    >
                        ...
                        <p style={{ color: "#8892a4", margin: 0, fontSize: 14 }}>
                    ...
                    >
                      ...
                      >
                        {wo.code}
                                    ...
                                    <td style={{ padding: "14px 16px" }}>
                                        {badge(wo.status, STATUS_COLORS[wo.status] || "#6b7280")}
                                    </td>
                                    <td style={{ padding: "14px 16px" }}>
                                        {badge(
                                            wo.priority,
                                            PRIORITY_COLORS[wo.priority] || "#6b7280"
                                        )}
                                    </td>
                                    <td style={{ padding: "14px 16px" }}>
                                        {badge(
                                            wo.slaStatus || "N/A",
                                            SLA_COLORS[wo.slaStatus] || "#6b7280"
                                        )}
                                    </td>
                                    <td
                                        style={{
                                    ...
                                    <td
                                        style={{
                                            padding: "14px 16px",
                                            fontSize: 13,
                                            color: wo.assignedToName ? "#b0bac9" : "#4a5568"
                                        }}
                                    >
                                        {wo.assignedToName || "—"}
                                    </td>
